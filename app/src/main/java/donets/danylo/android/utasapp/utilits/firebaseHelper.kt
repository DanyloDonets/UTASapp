...
import donets.danylo.android.utasapp.models.User
...
const val CHILD_PHOTO_URL = "empty"
...
fun initFirebase() {
    ...
    REF_DATABASE_ROOT = FirebaseDatabase.getInstance("https://utas-app-f53e6-default-rtdb.europe-west1.firebasedatabase.app/").getReference()
    USER = User()
