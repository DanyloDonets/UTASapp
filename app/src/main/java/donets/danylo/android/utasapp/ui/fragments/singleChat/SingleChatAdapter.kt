...
import donets.danylo.android.utasapp.utilits.DiffUtilCallback
import donets.danylo.android.utasapp.utilits.TYPE_MESSAGE_IMAGE
import donets.danylo.android.utasapp.utilits.TYPE_MESSAGE_TEXT
...
class SingleChatAdapter : RecyclerView.Adapter<SingleChatAdapter.SingleChatHolder>() {
    ...
    override fun onBindViewHolder(holder: SingleChatHolder, position: Int) {
        Log.i("loging",mListMessagesCache[position].type)
